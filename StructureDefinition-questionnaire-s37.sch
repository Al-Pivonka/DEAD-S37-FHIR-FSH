...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Questionnaire/f:item">
      <sch:assert test="count(f:extension[@url = 'http://example.com/fhir/example/StructureDefinition/s37-settings']) &gt;= 1">extension with URL = 'http://example.com/fhir/example/StructureDefinition/s37-settings': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.com/fhir/example/StructureDefinition/s37-settings']) &lt;= 1">extension with URL = 'http://example.com/fhir/example/StructureDefinition/s37-settings': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:repeats) &gt;= 1">repeats: minimum cardinality of 'repeats' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
