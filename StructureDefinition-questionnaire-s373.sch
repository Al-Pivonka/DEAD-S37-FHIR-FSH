...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Questionnaire">
      <sch:assert test="count(f:extension[@url = 'http://science37.com/fhir/StructureDefinition/unknown-status-string']) &lt;= 1">extension with URL = 'http://science37.com/fhir/StructureDefinition/unknown-status-string': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
